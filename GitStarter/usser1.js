...
window.addEventListener("DOMContentLoaded",()=>{
    axios.get("https://crudcrud.com/api/cca4ee11d1994506923cc0a5ded8f186/appointmentData")
    .then((respone) => {
        console.log(respone);
...
function onsubmit(e){
    ...
    axios.post("https://crudcrud.com/api/cca4ee11d1994506923cc0a5ded8f186/appointmentData",obj)
    .then((respone) => {
...
function deletet(Uid) {
    axios.delete(`https://crudcrud.com/api/cca4ee11d1994506923cc0a5ded8f186/appointmentData/${Uid}`).then((respone) => {
    console.log(respone);    
    }).catch((err) => {
        console.log("error");
        console.log(Uid);
